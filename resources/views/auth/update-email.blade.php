        ...
        <div class="flex">
            <div class="w-full">
                ...
                <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                    ...
                    <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('users.email-update') }}">
                        @csrf

                        <div class="flex flex-wrap">
                            <label for="email" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                                {{ __('New e-mail address') }}:
                            </label>

                            <input id="email" type="email"
                                   class="form-input w-full border border-gray-500 @error('email') border-red-500 @enderror" name="email"
